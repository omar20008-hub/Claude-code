...
/* -------------------------------------------------------------------------- */
/* Form controls live in ./form.tsx                                           */
/*                                                                            */
/* Field, Input, Textarea, Select and Checkbox moved to a 'use client' module  */
/* so Field can publish its label/aria wiring through React context. Cloning   */
/* the child to inject it silently broke whenever a field needed a wrapper —   */
/* see the note at the top of form.tsx. Everything left in this file is        */
/* server-renderable.                                                          */
/* -------------------------------------------------------------------------- */
